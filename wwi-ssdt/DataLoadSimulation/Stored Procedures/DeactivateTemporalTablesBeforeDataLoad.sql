...
AS BEGIN
    ...
    IF EXISTS(select t.temporal_type
            from sys.tables t 
    ...
    IF EXISTS(select t.temporal_type
            ...
            inner join sys.schemas s 
            on t.schema_id = s.schema_id 
            where t.name = 'SupplierCategories'
    ...
    IF EXISTS(select t.temporal_type
            ...
            inner join sys.schemas s 
            on t.schema_id = s.schema_id 
            where t.name = 'CustomerCategories'
            and s.name = 'Sales' 
            and t.temporal_type = 2)
    BEGIN   
    ...
    IF EXISTS(select t.temporal_type
            ...
            inner join sys.schemas s 
            on t.schema_id = s.schema_id 
            where t.name = 'ColdRoomTemperatures'
